...
\autor{Jafer Daltro Pompeu Júnior}
\titulo{Análise Comparativa entre Modelos de Redes Neurais Supervisionadas e não Supervisionadas}
\data{2017}
...
\orientador{Profº Dr. Gustavo Augusto Lima de Campos}
